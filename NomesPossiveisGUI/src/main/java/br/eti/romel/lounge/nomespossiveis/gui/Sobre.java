...
public class Sobre extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        java.util.ResourceBundle bundle = java.util.ResourceBundle.getBundle("br/eti/romel/lounge/nomespossiveis/gui/resourceBundle"); // NOI18N
        jLabelCopyRight.setText(bundle.getString("COPYRIGHT(C) 2012 CARLOS ROMEL")); // NOI18N

        jLabeljExtenso.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabeljExtenso.setText(bundle.getString("NOMES POSSÍVEIS")); // NOI18N

        jToggleButtonOk.setText(bundle.getString("OK")); // NOI18N
        ...
        jLabelEMail.setText(bundle.getString("CARLOS.ROMEL@GMAIL.COM")); // NOI18N
